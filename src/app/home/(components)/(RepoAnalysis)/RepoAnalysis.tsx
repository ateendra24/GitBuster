...
const RepoAnalysis: React.FC<ChatInterfaceProps> = ({ url }) => {
    ...
    return (
        <>
            <Tabs defaultValue="chat" className="w-full max-w-6xl mx-auto mt-16 h-full" onValueChange={(value) => setActiveTab(value)}>
                <TabsList className="w-full">
                    <TabsTrigger value="chat">Chat</TabsTrigger>
                    <TabsTrigger value="summary">Summary</TabsTrigger>
                </TabsList>

                <div className="flex flex-col h-full CustomCardHeight">
                    <TabsContent value="chat" className="flex-1 overflow-hidden border rounded-lg">
                        <Card className="flex relative flex-col w-full rounded-lg overflow-hidden dark:bg-[#2a2a2a] gap-0 p-0 h-full">
